...
class MyPasswordChange(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(label=_('New Password'), strip=False, widget= forms.PasswordInput(attrs={'autocomplete':'current-password', 'autofocus':True, 'class':'from-control'}),
